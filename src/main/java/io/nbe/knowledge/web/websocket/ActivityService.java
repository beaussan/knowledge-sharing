package io.nbe.knowledge.web.websocket;

import io.nbe.knowledge.security.SecurityUtils;
import io.nbe.knowledge.web.websocket.dto.ActivityDTO;
...
import static io.nbe.knowledge.config.WebsocketConfiguration.IP_ADDRESS;
